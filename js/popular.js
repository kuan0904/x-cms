...
function getPopular() {
    $.post('../libs/php/process/cls.popular.php', {"p_ACTION": "List", "p_PAGE": "1", "p_LIMIT": p_LIMIT, "_": new Date().getTime() }, function (data) {
        $("#wContent").html(data);
        addEvent();
	});		
}
...
function addEvent() {
	$("#numberpager").find("span").click(function(){
	    ...
	    $.post('../libs/php/process/cls.popular.php', {"p_ACTION": "List", "p_PAGE": p_PAGE, "p_LIMIT": p_LIMIT, "_": new Date().getTime() }, function (data) {
	        $("#wContent").html(data);
	        addEvent();
		});		
	});	
...
function btnDel(_key) {
	if(confirm("確定要刪除該筆資料嗎？")) {
	    $.post('../libs/php/process/cls.popular.php', {"p_NID": _key, "p_PAGE": p_PAGE, "p_LIMIT": p_LIMIT, "p_ACTION": "Delete", "_": new Date().getTime() }, function (data) {
	        $("#wContent").html(data);
	        addEvent();
		});			
	}
...
function btnModify(_key) {
    $.post('../libs/php/process/cls.popular.php', {"p_NID": _key, "p_PAGE": p_PAGE, "p_LIMIT": p_LIMIT, "p_ACTION": "Modify", "_": new Date().getTime() }, function (data) {
...
function btnAdd() {
    $.post('../libs/php/process/cls.popular.php', {"p_PAGE": p_PAGE, "p_LIMIT": p_LIMIT, "p_ACTION": "Add", "_": new Date().getTime() }, function (data) {
        $.getScript("//cdn.ckeditor.com/4.4.5/full/ckeditor.js")
	    .done(function() { 
	        $("#wContent").html(data);
...
function btnSubmit(_key) {
	...
	if (p_NTITLE == "") {
		...
		p_NNAME =base64_encode(p_NNAME);
		p_NCONT =base64_encode(p_NCONT);
	    $.post('../libs/php/process/cls.popular.php', {
	    	"p_NID": _key, "p_NTITLE": p_NTITLE, "p_NNAME": p_NNAME, "p_NCONT": p_NCONT, "p_NDATE": p_NDATE, "p_NSTATUS": p_NSTATUS,
...
function btnSubmit1() {
	...
	if (p_NTITLE == "") {
		...
		p_NCONT =base64_encode(p_NCONT);
	    $.post('../libs/php/process/cls.popular.php', {
	    	"p_NTITLE": p_NTITLE, "p_NNAME": p_NNAME, "p_NCONT": p_NCONT, "p_NDATE": p_NDATE,
