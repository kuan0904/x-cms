...
CKEDITOR.editorConfig = function (config) {
    ...
    config.removeButtons = 'Smiley,NumberedList,BulletedList,SpellChecker,Language,Save,Print,Preview,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Anchor';
