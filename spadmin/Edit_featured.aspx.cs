...
public partial class spadmin_Edit_featured : System.Web.UI.Page
{
    string unitid = "";
    ...
    protected void link_edit(object sender, System.EventArgs e)
    {
        ...
        dt.Dispose();
        strsql = "select * from tbl_featured where bannerid=@bannerid";
        dt = DbControl.Data_Get(strsql, nvc);
    ...
    protected void Btn_save_Click(object sender, System.EventArgs e)
    {
        ...
        {
            strsql = "delete from tbl_featured where bannerid=@id";           
        ...
        for (i=0;i< classid.Items.Count; i++)
        {
            ...
            {
                nvc.Clear();
                strsql = "insert into tbl_featured (bannerid,classid) values (@bannerid,@classid) ";
                nvc.Add("bannerid", Selected_id.Value);
    ...
    {
        NameValueCollection nvc = new NameValueCollection();
        string strsql = "select * from  tbl_banner  where classid in( select  classid  from tbl_banner_class where unitid =4 ) ";
