...
public class fb_login : IHttpHandler ,IRequiresSessionState {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        else
        {
            ...
            //string FacebookAppId = "1926056380816841"; // .inspire-love
            //string FacebookAppSecret = "58783c19510ea7e1f278138633858ef4"; //.inspire-love
            ...
            {
                string m = "<script>alert('登入失敗');location.href='/';</script>";
            ...
            if (p_ACCOUNT != "")
            {
                ...
                {
                    result = MemberLib.Member.Add(email, p_PASSWD, p_ACCOUNT,name);
