          ...
          <div class="widget-body">
            <div class="widget-main padding-4">
                ...
                <div id="item1" class="tab-pane active">   
                        ...
                        <tr>
                            <td>內容</td>
                            <td>  <input id="contents" type="text"   style="height: 600px" />
                        ...
                        <tr  >
                            <td>標籤</td>
                            <td><label id="tag"></label> 
							</td>
											
                        </tr>
                        <tr  >
                            <td>作者</td>
                            <td>	<label id="writer"></label> 
                         	</td>
                        </tr>
                        <tr >
                            <td>關鍵字</td>
                            <td><input type="text" name="keywords" id="keywords" value="" width="600px" placeholder="請輸入關鍵字 ..." />
                ...
                <button type="button" class="btn btn-primary" onclick="ret()">返回</button>
                            ...
                            <button type="button" class="btn btn-primary" >存 檔</button>
                <button type="button" class="btn btn-primary" id="preview">預覽</button>
                 <button type="button" class="btn btn-primary" id="btn-next">新增文章</button>
