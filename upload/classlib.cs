...
namespace unity {
    ...
    public static class classlib
    {
        ...
        private static string delivername = "funuv";
        private static string servicemail = "service@funuv.com";
   ...
   //                 }
        ...
        public static string Get_coupon_price(string memberid, string discount_no)
        {
            string cc_money = "0";
            using (SqlConnection conn = new SqlConnection(classlib.dbConnectionString))
            {
            ...
            and num >0 and convert(varchar, getdate(), 111) between strdate and enddate   ";
                ...
                if (rs.Read())
                {
                    ...
                    else if (rs["memberid"].ToString() != "" && rs["memberid"].ToString() != memberid) cc_money = "-2";
                    else
                        cc_money = rs["money"].ToString();// "100";
