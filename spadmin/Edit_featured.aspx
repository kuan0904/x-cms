<%@ Page Title="" Language="C#" MasterPageFile="~/spadmin/admin.master" AutoEventWireup="true" CodeFile="Edit_featured.aspx.cs" Inherits="spadmin_Edit_featured" %>
    ...
    <asp:View ID="View1" runat="server">	        
      <script>
          function preview() {
              ...
              window.open( "/3/lesson?kind=preview", '_blank');
